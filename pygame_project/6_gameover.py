...
while running:
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        for weapon_idx, weapon_val in enumerate(weapons):
            ...
            if weapon_rect.colliderect(ball_rect):
                weapon_to_remonve = weapon_idx # 해당 무기 없애기 위한 값 설정
        ...
        break # 안쪽 for 문에서 break를 만나면 여기로 진입 가능 . 2중 for 문 한번에 탈출
    ...
    if weapon_to_remonve > -1:
        del weapons[weapon_to_remonve]
        weapon_to_remonve = -1
